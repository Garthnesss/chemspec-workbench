"""Smoke test for examples/benzene_uvvis_walkthrough.py (cheap; no nbconvert)."""
...
SCRIPT = ROOT / "examples" / "benzene_uvvis_walkthrough.py"
FIXTURE = ROOT / "fixtures" / "public" / "benzene_uvvis_nist.jdx"
...
def walkthrough_mod():
    ...
    spec = importlib.util.spec_from_file_location("benzene_uvvis_walkthrough", SCRIPT)
...
def test_walkthrough_script_exists() -> None:
    ...
    nb = ROOT / "examples" / "benzene_uvvis_walkthrough.ipynb"
    assert nb.is_file()
